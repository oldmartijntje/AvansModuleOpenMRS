 ...
 */
package org.openmrs.module.bahmni.appointment.forwarder.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.BahmniAppointmentForwarderController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class BahmniAppointmentForwarderController {
