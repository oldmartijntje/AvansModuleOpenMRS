...
public class MySQLMemberDAO implements IMemberDAO {
    ...
    MySQLMemberDAO() {
        ...
        Member aNewMember = new Member(1000, "Henk", "Hopper, de", new BurgerServiceNummer("fake-id"));
        ...
        aNewMember = new Member(1001, "Mara", "Machtig", new BurgerServiceNummer("fake-id"));
        members.add(aNewMember);
        c.setTime(dateToday);
        ...
        aNewMember = new Member(1002, "Kees", "Kerfstok", new BurgerServiceNummer("fake-id"));
        members.add(aNewMember);
        ...
        aNewMember = new Member(1003, "Anna", "Nas", new BurgerServiceNummer("fake-id"));
        aNewMember.setFine(5.25);
        members.add(aNewMember);

        members.add(new Member(1004, "Cor", "Netto", new BurgerServiceNummer("fake-id")));
    }
